...
export default function Home() {
  ...
  const [event, setEvent] = useState({ isAddBoard: false });
  ...
  const addBoard = () => setEvent({ ...event, isAddBoard: true });

  const view = () => console.log(user);
    ...
    <>
      <div className=" h-screen bg-cover bg-center bg-no-repeat bg-anime-bg">
        ...
        <div className="container mx-auto ">
          <div className="mt-10 ">
            <h1 className="text-2xl font-bold cursor-pointer" onClick={view}>
              Boards
            </h1>
            ...
            <div className="grid grid-cols-3 gap-3 my-5">
              <DisplayBoard />
              {event.isAddBoard ? (
                <AddBoard event={event} setEvent={setEvent} />
              ) : (
                <div
